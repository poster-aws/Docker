...
CREATE TABLE `Astro` (
  ...
  `mois` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `annee` tinyint unsigned NOT NULL,
  `signe` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`Tirage`)
...
INSERT INTO `Astro` VALUES ('2026-01-01',6,'Juin',71,'VIERGE'),('2026-01-02',22,'Mai',49,'LION'),('2026-01-03',19,'Février',48,'LION'),('2026-01-04',21,'Août',74,'TAUREAU'),('2026-01-05',27,'Décembre',10,'VERSEAU'),('2026-01-06',11,'Septembre',0,'LION');
...
-- Dump completed on 2026-01-07 18:07:49
