-- Добавление одной строки в Q2_stats_norder: только для самой свежей записи из Q2.
-- Порядок цифр не важен: (4,5) и (5,4) — одна комбинация.
-- Таблица Q2_stats_norder уже должна существовать.
